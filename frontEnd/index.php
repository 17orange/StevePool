...
<html xmlns="https://www.w3.org/1999/xhtml" lang="en">
  <head>
    ...
    <link href="includes/stevePool.css?cacheBuster=4" rel="stylesheet" type="text/css">
...
?>
    ...
    <script type="text/javascript">
      ...
      if( true && check ) 
      {
        // update this stuff for mobile
        $(".mainHeader").addClass("mainHeaderMobile");
        $(".poolLogo").addClass("poolLogoMobile");
        $(".loggedInInfo").addClass("loggedInInfoMobile");
        $(".mainTitle").addClass("mainTitleMobile");
        $(".mainSubtitle").addClass("mainSubtitleMobile");
        $(".deadlineInfo").addClass("deadlineInfoMobile");
        $(".navButton").addClass("navButtonMobile");
        $(".navButtonActive").addClass("navButtonActiveMobile");
      }
    </script>
  </body>
</html>
